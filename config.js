...
global.namebot = 'ABOTZ'
global.nameown = 'PRIVATE'
...
/*============== WATERMARK ==============*/
global.wm = '「 INFO KATA² MOTIVASI 」' //Main Watermark
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘ABOTZ-BOT ˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ ABOTZ-BOT '
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `T I M E : ${wktuwib}`
global.titlebot = `⫹⫺ WhatsApp Bot | By Owner`
global.packname = 'ABotz WhatsApp'
global.author = '                「 ABOTZ  あ」'
